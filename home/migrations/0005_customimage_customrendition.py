    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.CharField(blank=True, max_length=255, verbose_name='Автор')),
                ('origin', models.CharField(blank=True, max_length=255, verbose_name='Сылка на оригинал')),
